...
**/
define(['jquery', 'underscore', 'encoder','ViewAdapter', 'ViewAdapterText', 'labels', 'jsesc'], function($, _, Encoder, ViewAdapter, ViewAdapterText, labels, jsesc){
    return {
		...
		getExternPublicationInfo : {
			...
			getQuery : function(parameters){
				...
				var query =     ' SELECT DISTINCT ?publiTitle ?publiDate ?publiJournal ?publiLink ?publiResume WHERE {  '+
								...
								' } ';
                return { query : prefix+query , output : "json"};
			},
